...
const RandomCalendar: React.FC = () => {
  const startDate = subYears(new Date(), 1); // Subtrai 1 ano da data atual.
      ...
      <div className="wrapper">
        <Heatmap
          ...
          classForValue={(item: HeatmapValue) => {
            ...
            if(item !== null) {
              clampedCount = Math.max(item.count, 0); // valor nao pode ser menor que 0
              clampedCount = Math.min(item.count, 4); // Valor nao pode ser maior que 4
            }
